...
本人（百度ID：Elia_is_me）早前曾经做过一个 elplaylist的教程，尽管仓促却也够详细，不过后来 ID被封帖子也不再可见，去年（2013年）还能找到网页快照，今年则完全无影无踪了，所以顺便就重写一个。为了防止再次因为ID 被封导致帖子找不到，所以这次会保留离线版，可能还会上传到 GitHub上，被删的风险应该没有了。
